...
import dev.langchain4j.model.openai.internal.audio.AudioTranscriptionRequest;
import dev.langchain4j.model.openai.internal.audio.AudioTranscriptionResponse;
...
public abstract class OpenAiClient {
    ...
    public abstract SyncOrAsync<AudioTranscriptionResponse> audioTranscription(AudioTranscriptionRequest request);
