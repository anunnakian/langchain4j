...
public class ResponseFormat {
    ...
    public static final ResponseFormat SRT = ResponseFormat.builder().type(ResponseFormatType.SRT).build();
    public static final ResponseFormat VERBOSE_JSON = ResponseFormat.builder().type(ResponseFormatType.VERBOSE_JSON).build();
    public static final ResponseFormat VTT = ResponseFormat.builder().type(ResponseFormatType.VTT).build();
    public static final ResponseFormat DIARIZED_JSON = ResponseFormat.builder().type(ResponseFormatType.DIARIZED_JSON).build();
